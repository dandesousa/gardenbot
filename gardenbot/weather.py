...
class ForecastIODataSource(object):
    ...
    @lru_cache(maxsize=cache_size)
    def _get_forecast_data(self, location, d):
        pass
    ...
    def _get_historical_rainfall(self, location, d):
        ...
        accumulated_rainfall = sum(hr['precipIntensity'] for hr in hourly_data if hr['precipType'] == 'rain')
        return accumulated_rainfall

    def _get_forecasted_rainfall(self, location, d):
        pass
    ...
    def get_rainfall(self, location, d):
        if d <= date.today():
            ...
            return self._get_forecasted_rainfall(self, location, d)
